...
![](PA1_template_files/figure-markdown_github/histogram%20TotSteps-1.png)
...
The mean of the total number of steps taken per day is 1.076618910^{4} and the median is 10765.
...
Now we will create a histogram of the total number of steps taken each day using this new data set and calculate and report on the mean and median total number of steps taken per day. To create our histogram we first need to summarise our data by date.
...
Using the new data set with filled missing values, the mean of the total number of steps taken each day is 1.076618910^{4} and the median is 1.076618910^{4}.

Are there differences in activity patterns between weekdays and weekends?
-------------------------------------------------------------------------

To determine if there are differences in activity patterns between weekdays and weekends we will create a new factor variable in the dataset with two levels - “weekday” and “weekend” indicating whether a given date is a weekday or weekend day.
...
Now we will create a panel plot containing a time series plot of the 5-minute interval (x-axis) and the average number of steps taken, averaged across all weekday days or weekend days (y-axis). To do this we first need to summarise our data by weekday/weekend and interval.
...
![](PA1_template_files/figure-markdown_github/ggplot-1.png)
